const styles = {
    ...
    button: 'w-[150px] bg-006665 hover:bg-fe8373 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    button1: 'w-[150px] bg-fe8373 hover:bg-006665 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
