...
const DashboardHero = () => {
  ...
  return (
    <div className="w-full p-8 px-[50px]">
      <h3 className="text-[25px] font-Poppins pb-4">Overview</h3>
      <div className="w-full block 800px:flex items-center justify-between">
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded-2xl px-4 py-5">
        ...
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded-2xl px-4 py-5">
          <div className="flex flex-row items-center justify-between p-2">
            <div className="flex items-center">
              ...
              <h3
                className={`${styles.productTitle} !text-[18px] leading-5 !font-[400] text
                -[#00000085]`}
              >
                All Orders
              </h3>
      ...
      <div className="w-full min-h-[45vh] bg-white rounded-3xl shadow">
        {isLoading ? (
          <Loader />
        ) : (
          <div className="">
            <div className="flex p-4 justify-end px-[50px]">
