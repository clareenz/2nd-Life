        ...
        <div>
          <input
            ...
            className="text-gray-500
                sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded-3xl px-2 focus:outline-none px-5"
          />
          <button className="bg-[#FF8474] hover:bg-[#006665] duration-300 px-5 py-2.5 rounded-3xl text-white md:w-auto w-full">
            Submit
          </button>
        </div>
      </div>
