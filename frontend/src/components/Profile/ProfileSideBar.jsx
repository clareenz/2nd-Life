  ...
  return (
    <div className="w-full bg-white shadow-sm rounded-[10px] p-4 pt-8">
      ...
      >
        ...
        <span className={`pl-3 ${active === 1 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Profile
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 ${active === 2 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Orders
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 ${active === 4 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Inbox
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 ${active === 5 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Track Order
        </span>
      </div>
      <div
        ...
        onClick={() => setActive(6)}
      >
        <AiOutlineCreditCard size={20} color={active === 6 ? "006665" : ""} />
        <span className={`pl-3 ${active === 6 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Payment Methods
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 ${active === 7 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Address
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 ${active === 8 ? "text-[#FE8373]" : ""} 800px:block hidden`}>
          Log Out
        </span>
      </div>
    </div>
