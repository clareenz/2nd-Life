  ...
  return (
    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://logos-world.net/imageup/Lacoste/Lacoste-Logo-PNG5.png"
            alt=""
            style={{width:"150px", objectFit:"contain"}}
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://logos-world.net/imageup/Gucci/Gucci-Logo-PNG3.png"
            alt=""
            style={{width:"150px", objectFit:"contain"}}
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://logos-world.net/imageup/Versace/Versace-Logo-PNG8.png"
            alt=""
            style={{width:"150px", objectFit:"contain"}}
          />
        </div>
